...
.dark-theme .mat-pseudo-checkbox-checked, .dark-theme .mat-pseudo-checkbox-indeterminate {
  border: none; }
...
.dark-theme .mat-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .dark-theme .mat-icon-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .dark-theme .mat-raised-button.mat-button-focus.mat-primary .mat-button-focus-overlay, .dark-theme .mat-fab.mat-button-focus.mat-primary .mat-button-focus-overlay, .dark-theme .mat-mini-fab.mat-button-focus.mat-primary .mat-button-focus-overlay {
  background-color: rgba(194, 24, 91, 0.12); }

.dark-theme .mat-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .dark-theme .mat-icon-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .dark-theme .mat-raised-button.mat-button-focus.mat-accent .mat-button-focus-overlay, .dark-theme .mat-fab.mat-button-focus.mat-accent .mat-button-focus-overlay, .dark-theme .mat-mini-fab.mat-button-focus.mat-accent .mat-button-focus-overlay {
  background-color: rgba(96, 125, 139, 0.12); }

.dark-theme .mat-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .dark-theme .mat-icon-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .dark-theme .mat-raised-button.mat-button-focus.mat-warn .mat-button-focus-overlay, .dark-theme .mat-fab.mat-button-focus.mat-warn .mat-button-focus-overlay, .dark-theme .mat-mini-fab.mat-button-focus.mat-warn .mat-button-focus-overlay {
  background-color: rgba(244, 67, 54, 0.12); }
...
.dark-theme .mat-button, .dark-theme .mat-icon-button {
  ...
  .dark-theme .mat-button.mat-primary[disabled], .dark-theme .mat-button.mat-accent[disabled], .dark-theme .mat-button.mat-warn[disabled], .dark-theme .mat-button[disabled][disabled], .dark-theme .mat-icon-button.mat-primary[disabled], .dark-theme .mat-icon-button.mat-accent[disabled], .dark-theme .mat-icon-button.mat-warn[disabled], .dark-theme .mat-icon-button[disabled][disabled] {
    color: rgba(255, 255, 255, 0.3); }
  .dark-theme .mat-button:hover.mat-primary .mat-button-focus-overlay, .dark-theme .mat-icon-button:hover.mat-primary .mat-button-focus-overlay {
    background-color: rgba(194, 24, 91, 0.12); }
  .dark-theme .mat-button:hover.mat-accent .mat-button-focus-overlay, .dark-theme .mat-icon-button:hover.mat-accent .mat-button-focus-overlay {
    background-color: rgba(96, 125, 139, 0.12); }
  .dark-theme .mat-button:hover.mat-warn .mat-button-focus-overlay, .dark-theme .mat-icon-button:hover.mat-warn .mat-button-focus-overlay {
    background-color: rgba(244, 67, 54, 0.12); }
...
.dark-theme .mat-input-placeholder {
  color: rgba(255, 255, 255, 0.3); }
  .dark-theme .mat-input-placeholder.mat-focused {
    color: #c2185b; }
    .dark-theme .mat-input-placeholder.mat-focused.mat-accent {
      color: #607d8b; }
    .dark-theme .mat-input-placeholder.mat-focused.mat-warn {
      color: #f44336; }
...
.dark-theme .mat-input-placeholder.mat-float.mat-focused .mat-placeholder-required {
  color: #607d8b; }
...
.dark-theme .mat-progress-spinner path, .dark-theme .mat-progress-circle path, .dark-theme .mat-spinner path {
  stroke: #d81b60; }

.dark-theme .mat-progress-spinner.mat-accent path, .dark-theme .mat-progress-circle.mat-accent path, .dark-theme .mat-spinner.mat-accent path {
  stroke: #546e7a; }

.dark-theme .mat-progress-spinner.mat-warn path, .dark-theme .mat-progress-circle.mat-warn path, .dark-theme .mat-spinner.mat-warn path {
  stroke: #e53935; }
...
.dark-theme .mat-select-trigger {
  ...
  .mat-select:focus:not(.mat-select-disabled) .dark-theme .mat-select-trigger {
    color: #c2185b; }
  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .dark-theme .mat-select-trigger {
    color: #f44336; }
...
.dark-theme .mat-select-underline {
  ...
  .mat-select:focus:not(.mat-select-disabled) .dark-theme .mat-select-underline {
    background-color: #c2185b; }
  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .dark-theme .mat-select-underline {
    background-color: #f44336; }
...
.dark-theme .mat-select-arrow {
  ...
  .mat-select:focus:not(.mat-select-disabled) .dark-theme .mat-select-arrow {
    color: #c2185b; }
  .mat-select.ng-invalid.ng-touched:not(.mat-select-disabled) .dark-theme .mat-select-arrow {
    color: #f44336; }
...
.dark-theme .mat-slide-toggle.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {
  background-color: rgba(255, 255, 255, 0.12); }

.dark-theme .mat-slide-toggle.mat-slide-toggle-focused .mat-ink-ripple {
...
.dark-theme .mat-slide-toggle.mat-primary.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {
  background-color: rgba(255, 255, 255, 0.12); }

.dark-theme .mat-slide-toggle.mat-primary.mat-slide-toggle-focused .mat-ink-ripple {
...
.dark-theme .mat-slide-toggle.mat-warn.mat-slide-toggle-focused:not(.mat-checked) .mat-ink-ripple {
  background-color: rgba(255, 255, 255, 0.12); }

.dark-theme .mat-slide-toggle.mat-warn.mat-slide-toggle-focused .mat-ink-ripple {
...
.dark-theme .mat-slider-track-fill {
  background-color: #607d8b; }

.dark-theme .mat-slider-thumb {
  background-color: #607d8b; }
...
.dark-theme .mat-slider-active .mat-slider-track-background {
  background-color: rgba(0, 0, 0, 0.38); }
...
.dark-theme .mat-slider-min-value.mat-slider-thumb-label-showing.mat-slider-active .mat-slider-thumb,
.dark-theme .mat-slider-min-value.mat-slider-thumb-label-showing.mat-slider-active .mat-slider-thumb-label {
  background-color: rgba(0, 0, 0, 0.26); }
...
.dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover .mat-slider-thumb, .dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing).mat-slider-active .mat-slider-thumb {
  border-color: rgba(0, 0, 0, 0.38); }

.dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing):hover.mat-slider-disabled .mat-slider-thumb, .dark-theme .mat-slider-min-value:not(.mat-slider-thumb-label-showing).mat-slider-active.mat-slider-disabled .mat-slider-thumb {
  border-color: rgba(0, 0, 0, 0.26); }
